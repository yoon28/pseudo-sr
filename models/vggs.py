"""
https://github.com/xinntao/BasicSR/blob/master/basicsr/models/archs/vgg_arch.py
"""
import os
import torch
...
if __name__ == "__main__":
    vgg = VGGFeatureExtractor(["conv5_4"], use_input_norm=True, range_norm=False)
    X = torch.randn(2, 3, 64, 64, dtype=torch.float32)
    Y = vgg(X)
    print(X.size(), Y["conv5_4"].size())
